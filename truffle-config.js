...
// public/private key pairs. If you're publishing your code to GitHub make sure you load this
// phrase from a file you've .gitignored so it doesn't accidentally become public.
 const mnemonic = YOUR_PRIVATE_KEY_HERE;
...
module.exports = {
  ...
  // choose a specific folder to target when typing truffle compile:
  ...
  networks: {
    ...
    mainnet: {
      ...
      gas: 5500000,           // gas limit (configure individually, at least enough to not run out of gas)
      gasPrice: 100000000000, // gas price, configure according to network state
      confirmations: 1,       // # of confs to wait between deployments. (default: 0)
     // timeoutBlocks: 200,   // # of blocks before a deployment times out  (minimum/default: 50)
